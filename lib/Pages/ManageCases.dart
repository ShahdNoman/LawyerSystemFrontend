...
//         ? 'http://192.168.88.13:4000/adminRoutes/viewAll-cases' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/viewAll-cases'; // For Android Emulator
...
//         ? 'http://192.168.88.13:4000/adminRoutes/get-attachment' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/get-attachment'; // For Android Emulator

//     print("attdata is $attdata");

//     final response = await http.post(
//       Uri.parse(attdata), // Adjust the URL to match your backend endpoint
//       headers: <String, String>{
//         'Content-Type': 'application/json; charset=UTF-8',
//         'Authorization': 'Bearer $token',
//       },
...
//         ? 'http://192.168.88.13:4000/adminRoutes/get-complaint' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/get-complaint'; // For Android Emulator

//     print("compdata is $compdata");

//     final response = await http.post(
//       Uri.parse(compdata), // Adjust the URL to match your backend endpoint
//       headers: <String, String>{
//         'Content-Type': 'application/json; charset=UTF-8',
//         'Authorization': 'Bearer $token',
//       },
...
//         ? 'http://192.168.88.13:4000/adminRoutes/get-sessions' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/get-sessions'; // For Android Emulator

//     print("sessdata is $sessdata");

//     final response = await http.post(
//       Uri.parse(sessdata), // Adjust the URL to match your backend endpoint
//       headers: <String, String>{
//         'Content-Type': 'application/json; charset=UTF-8',
//         'Authorization': 'Bearer $token',
//       },
...
//         ? 'http://192.168.88.13:4000/adminRoutes/get-payments' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/get-payments'; // For Android Emulator

//     print("paydata is $paydata");

//     final response = await http.post(
//       Uri.parse(paydata), // Adjust the URL to match your backend endpoint
//       headers: <String, String>{
//         'Content-Type': 'application/json; charset=UTF-8',
//         'Authorization': 'Bearer $token',
//       },
...
// //                     senderName: adminName, // Replace with actual sender name
// //                     profilePic: adminPicUrl,
// //                     senderId: adminId, // Replace with actual sender ID
// //                   ),
// //                 ),              );
//             },
//           ),
...
//         ? 'http://192.168.88.13:4000/adminRoutes/create-case' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/create-case'; // For Android Emulator
...
//         ? 'http://192.168.88.13:4000/adminRoutes/update-case-status/$caseId' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/update-case-status/$caseId'; // For Android Emulator
...
//         ? 'http://192.168.88.13:4000/adminRoutes/delete-case/$caseId' // For Web (Chrome)
//         : 'http://10.0.2.2:4000/adminRoutes/delete-case/$caseId'; // For Android Emulator
...
class _ManageCasesState extends State<ManageCases> {
  ...
  Future<List<dynamic>> fetchCases(String token) async {
    final casedata = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/viewAll-cases'
  ...
  Future<List<Map<String, dynamic>>> fetchAttachmentsForCase(
      int caseId, String token) async {
    final attdata = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/get-attachment'
  ...
  Future<List<Map<String, dynamic>>> fetchComplaintsForCase(
      int caseId, String token) async {
    final compdata = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/get-complaint'
  ...
  Future<List<Map<String, dynamic>>> fetchSessionsForCase(
      int caseId, String token) async {
    final sessdata = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/get-sessions'
  ...
  Future<List<Map<String, dynamic>>> fetchPaymentsForCase(
      int caseId, String token) async {
    final paydata = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/get-payments'
  ...
  Future<void> _addCase(
    ...
    final crecase = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/create-case'
  ...
  Future<void> _updateCaseStatus(String caseId, String status) async {
    ...
    String? token = box.get('token');
    final updcase = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/update-case-status/$caseId'
  ...
  Future<void> _deleteCase(String caseId) async {
    ...
    String? token = box.get('token');
    final delecase = kIsWeb
        ? 'http://192.168.88.11:4000/adminRoutes/delete-case/$caseId'
...
//                   vertical: 10.0,
//                   horizontal:
//                       MediaQuery.of(context).size.width > 600 ? 100.0 : 0.0),
//               child: InkWell(
//                 onTap: () {
//                   _showCaseDetails(caseData);
//                 },
