...
//   NotificationPage({Key? key, required this.updateCount}) : super(key: key);
...
//     print('id of notification that i recives is $notificationId');
//     final response = await http.delete(
//       Uri.parse(
//           'http://10.0.2.2:4000/adminRoutes/notifications/$notificationId'),
//       headers: {
//         'Content-Type': 'application/json; charset=UTF-8',
//         'Authorization': 'Bearer $token',
//       },
...
//                         child: IconButton(
//                           icon:
//                               Icon(Icons.arrow_back, color: Color(0xFF003366)),
      ...
      try {
         ...
         if (response.statusCode == 200) {
           ...
           ScaffoldMessenger.of(context).showSnackBar(
             SnackBar(content: Text("تم حذف الإشعار بنجاح")),
           );
         } else {
           throw Exception('Failed to delete notification');
         }
      }catch (e){
        print("error from deletion $e");
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Error from delete $e")),
        );
      }
  }
